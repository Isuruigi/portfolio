...
const projects: Project[] = [
    // Production/Completed Projects First
    {
        ...
        title: "PersonaPlex: Full-Duplex Voice AI Agent",
        impact: "Production-ready voice AI agent that answers real phone calls with sub-second latency.",
        challenge: "Building a voice AI agent capable of handling real-world phone calls with natural interruptions and ultra-low latency.",
        solution: "Integrated Twilio, Deepgram for fast STT with end-of-speech detection, OpenAI for logic, and Edge TTS to create a highly responsive, customizable voice agent.",
        results: [
        ...
        tech: ["Python", "Twilio", "Deepgram STT", "OpenAI", "Edge TTS", "FastAPI"],
        github: "https://github.com/Isuruigi/personaplex-agent",
        demo: "",
        category: "Production",
        image: "https://opengraph.githubassets.com/1/Isuruigi/personaplex-agent",
    },
    {
        id: 2,
        status: "Completed",
        statusColor: "bg-green-500",
        title: "Real-Time AI Research Agent",
        impact: "Agentic system with autonomous web search, custom RAG, and automatic source citations.",
        challenge: "Needed an autonomous research assistant that can effectively search the web, compile information reliably, and provide accurate citations.",
        solution: "Built a LangGraph and FastAPI-based agentic system with custom RAG, robust error handling, and lazy initialization for seamless deployment.",
        results: [
        ...
        tech: ["LangGraph", "FastAPI", "RAG", "Multi-Agent", "Python"],
        github: "https://github.com/Isuruigi/ai-research-agent",
        demo: "",
        category: "Production",
        image: "https://opengraph.githubassets.com/1/Isuruigi/ai-research-agent",
    },
    {
        id: 3,
        status: "Completed",
        statusColor: "bg-green-500",
        title: "Cost-Aware Fraud Detection System",
        impact: "Production ML system optimized for business metrics (cost of false positives vs. false negatives)",
        challenge: "Built complete ML pipeline from feature engineering to production deployment that optimizes true business costs.",
        solution: "Developed end-to-end system with feature engineering, model training, evaluation tracking, deployment, and continuous monitoring.",
        results: [
        ...
        tech: ["XGBoost", "MLflow", "Cost-Aware ML", "CI/CD", "Python"],
    ...
    },
    {
        ...
        tech: ["LangChain", "GCP", "RAG", "Python", "Multi-Agent", "FastAPI"],
    ...
    },
    {
        ...
        tech: ["Python", "Drift Detection", "AIOps", "Monitoring", "Docker"],
    ...
    },
    {
        ...
        impact: "End-to-end ML system from feature engineering to production deployment",
        challenge: "Needed a validated ML business solution capable of predicting customer churn securely and proactively.",
        solution: "Developed a complete PyTorch-based ML pipeline covering feature engineering, model training, and production deployment.",
        results: [
        ...
        tech: ["PyTorch", "MLOps", "Docker", "CI/CD", "Python"],
        github: "https://github.com/Isuruigi/telco-churn-production",
        demo: "",
        category: "Production",
        image: "https://opengraph.githubassets.com/1/Isuruigi/telco-churn-production",
    },
    {
        id: 7,
        status: "Completed",
        ...
        impact: "AI-powered trading signal generator with real-time sentiment orchestration",
        ...
        solution: "Developed multi-agent system with Whale Tracker, Orderbook Analyzer, Sentiment Analyzer, and LLM Coordinator for comprehensive analysis.",
        results: [
        ...
        tech: ["Multi-Agent", "AIOps", "FastAPI", "Python", "WebSocket"],
    ...
    },
    {
        ...
        statusColor: "bg-blue-500",
        title: "MediAgent SL",
        impact: "Multilingual agentic healthcare navigator for Sri Lanka",
        challenge: "Public healthcare system serves 22M+ people with no automated triage. OPD patients face 4–6hr waits without pre-screening in multiple languages.",
        solution: "A 7-agent hierarchical system on LangGraph 1.0 with MCP for FHIR R4 clinical data, offering trilingual voice-based medical intake.",
        results: [
        ...
        tech: ["LangGraph", "Python", "MCP", "FastAPI", "PostgreSQL", "ChromaDB"],
        github: "future",
        demo: "Future Project",
        category: "Coming Soon",
    },
