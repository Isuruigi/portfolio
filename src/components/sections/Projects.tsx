...
const projects: Project[] = [
    ...
    // Coming Soon / Future Projects
    {
        ...
        impact: "Production-ready LoRA/QLoRA fine-tuning with automated deployment",
        challenge: "Need scalable framework for fine-tuning LLMs on domain-specific tasks with automated retraining and deployment optimization.",
        solution: "Building production-ready fine-tuning framework using LoRA/QLoRA techniques with automated retraining pipelines and deployment optimization.",
        results: [
        ...
        tech: ["PyTorch", "Transformers", "LoRA", "QLoRA", "MLOps", "Auto-Retraining"],
        github: "coming-soon",
        demo: "In Development",
